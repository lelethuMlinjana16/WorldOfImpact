...
{
    [TestFixture]
    public class About_Us_Dashboard : TestBase
    {
        ...
        public void CheckAboutUs()
        {
            ...
            IWebElement firstElementToClick = _wait.Until(ExpectedConditions.ElementToBeClickable(By.XPath("/html/body/div/div[2]/header/div[2]/nav[1]/ul/li[2]/a")));
            try
            {
            ...
            IWebElement specificElementToClick5 = _wait.Until(ExpectedConditions.ElementToBeClickable(By.XPath("//*[@id=\"root\"]/div[2]/header/div[2]/nav[1]/ul/li[2]/a")));
            try
            {
