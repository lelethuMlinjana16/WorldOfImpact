...
//{
//    [TestFixture]
//    public class BBGridView : TestBase
//    {
...
//        //[Test, Order(1)]
//        //public void Test_SelectCrimeDashboard()
//        //{
...
//        //    // Verify the selection or interaction with the map element
//        //    IWebElement mapVerificationElement = _wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("//div[contains(@class, 'map-selected')]"))); // Adjust XPath based on how selection is verified
//        //    Assert.That(mapVerificationElement.Displayed, Is.True, "The map element was not successfully selected.");
